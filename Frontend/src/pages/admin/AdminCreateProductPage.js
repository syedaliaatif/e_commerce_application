import { Row, Col, Button, Container, Form, CloseButton, Table, Alert } from "react-bootstrap";
                ...
                <Col md={6}>
                    ...
                    <Form className="mt-3" noValidate validated={validated} onSubmit={handleSubmit}>
                        <Form.Group className="mb-3" controlId="formBasicName">
                            ...
                            <Form.Control type="text" required name="productName" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicDescription">
                            <Form.Label>Description</Form.Label>
                            <Form.Control as="textarea" rows={3} style={{ resize: "none" }} required name="description" />
                        </Form.Group>
